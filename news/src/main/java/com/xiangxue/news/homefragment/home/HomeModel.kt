...
description :
 */
const val PREDEFINED_CHANNELS: String =
...
) : BaseMvvmModel<NewsChannelsBean, List<Channel>>(
    iBaseModelListener = iBaseModelListener, mCachedPreferenceKey = "channel_model_pref_key",
    apkPredefinedData = PREDEFINED_CHANNELS
) {
